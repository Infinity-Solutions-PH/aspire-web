    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <div class="flex-1 bg-white flex flex-col justify-center items-center p-8 sm:p-12 lg:p-24 overflow-y-auto">
            <div class="w-full max-w-[420px]">
                ...
                <button class="w-full bg-white border border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold h-14 rounded-xl transition-all flex items-center justify-center gap-3 px-4 shadow-sm" type="button">
