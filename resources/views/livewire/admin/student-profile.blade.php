    ...
    <div class="mb-8 flex flex-wrap justify-between items-center gap-4">
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col gap-1">
                <h2 class="text-3xl font-black tracking-tight text-[#1b0d0d] dark:text-[#fcf8f8]">Student Profile</h2>
                <p class="text-[#9a4c4c] dark:text-[#c48d8d] text-base font-medium">Comprehensive view of student information</p>
            </div>
        </div>
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.students.masterlist') }}" class="flex items-center gap-2 bg-gray-100 hover:bg-gray-200 dark:bg-[#2d1818] dark:hover:bg-[#3d2424] text-gray-700 dark:text-gray-300 px-4 py-2 rounded-xl text-sm font-bold border border-gray-200 dark:border-[#3d2424] transition-all">
