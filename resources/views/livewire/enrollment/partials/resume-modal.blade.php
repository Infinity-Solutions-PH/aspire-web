<div x-data="{ open: @entangle('showResumeModal') }" 
     x-show="open" 
                ...
                <div class="p-8 pt-6">
                    <div class="text-center">
                        <h3 class="text-2xl font-black tracking-tighter text-zinc-900 dark:text-white" id="modal-title">
                            Ongoing Application Found
                        </h3>
                        <div class="mt-4">
                            <p class="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
                                We found a previous draft associated with your LRN. Would you like to continue where you left off or start a fresh application?
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-3">
                        <button type="button" 
                                wire:click="resumeDraft" 
                                class="w-full inline-flex items-center justify-center gap-3 bg-primary text-white px-6 py-4 rounded-2xl font-bold text-sm tracking-wide shadow-xl shadow-primary/20 hover:bg-primary/90 hover:scale-[1.02] transition-all">
                            <span class="material-symbols-outlined text-lg">play_arrow</span>
                            Continue Application
                        </button>
                        <button type="button" 
                                wire:click="resetAndStartNew" 
