<section wire:key="step-3" class="glass-card rounded-xl shadow-sm border border-[#e7cfcf] dark:border-white/10 overflow-hidden">
    ...
    <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <label wire:key="f-current-house" class="flex flex-col gap-2">
            ...
            @error('formData.current_house_no') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
        </label>
        <label wire:key="f-current-barangay" class="flex flex-col gap-2">
            ...
            @error('formData.current_barangay') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
        </label>
        <label class="flex flex-col gap-2">
            ...
            @error('formData.current_municipality') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
        </label>
        <label class="flex flex-col gap-2">
            ...
            @error('formData.current_province') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
        </label>
        <label class="flex flex-col gap-2">
            ...
            @error('formData.current_zip') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
        </label>
        <label wire:key="f-current-country" class="flex flex-col gap-2">
            ...
            @error('formData.current_country') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
        </label>
        ...
        <div class="md:col-span-2 pt-4 border-t border-[#e7cfcf] dark:border-white/10 space-y-6">
            ...
            <div x-transition class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-black/5 dark:bg-white/5 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800">
                <label class="flex flex-col gap-2">
                    ...
                    @error('formData.permanent_house_no') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </label>
                <label class="flex flex-col gap-2">
                    ...
                    @error('formData.permanent_barangay') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </label>
                <label class="flex flex-col gap-2">
                    ...
                    @error('formData.permanent_municipality') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </label>
                <label class="flex flex-col gap-2">
                    ...
                    @error('formData.permanent_province') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </label>
                <label class="flex flex-col gap-2">
                    ...
                    @error('formData.permanent_zip') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </label>
                <label class="flex flex-col gap-2">
                    ...
                    @error('formData.permanent_country') <span class="text-xs text-red-500 mt-1">{{ $message }}</span> @enderror
                </label>
            </div>
            @endif
        </div>
