                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <label class="flex flex-col gap-2">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-[9px] text-zinc-500 bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded italic">If available</span>
                            </div>
                        ...
                        <div class="md:col-span-2 space-y-4 pt-4 border-t border-[#e7cfcf] dark:border-white/10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-2 ml-8 bg-black/5 dark:bg-white/5 p-4 rounded-xl">
                                @foreach([
                                ...
                                <label class="flex items-center gap-2 cursor-pointer group">
                                    <input type="checkbox" value="{{ $type }}" wire:model.defer="formData.disability_types" class="rounded text-primary focus:ring-primary h-4 w-4" />
                ...
                <section class="glass-card rounded-xl shadow-sm border border-[#e7cfcf] dark:border-white/10 overflow-hidden">
                    ...
                    <div class="p-8 grid grid-cols-1 gap-6">
                        ...
                        <label class="flex flex-col gap-2">
                            ...
                            <input wire:model.defer="formData.guardian_name" class="form-input rounded-lg border-[#e7cfcf] dark:border-white/20 bg-white/50 dark:bg-black/20 focus:border-primary focus:ring-primary h-12 text-sm" placeholder="Full Name (if applicable)" type="text"/>
                        </label>
                        <label class="flex flex-col gap-2 max-w-sm">
                            ...
                            <div class="relative">
                                ...
                                <input @if($is_resumed) value="{{ $this->maskValue('contact_no', $formData['contact_no']) }}" @endif
                                       ...
                                       class="form-input w-full rounded-lg border-[#e7cfcf] dark:border-white/20 bg-white/50 dark:bg-black/20 focus:border-primary focus:ring-primary h-12 text-sm pl-12 {{ $is_resumed ? 'text-gray-400' : '' }}" type="text" placeholder="9XXXXXXXXX"/>
                            </div>
                ...
                <section class="glass-card rounded-xl shadow-sm border border-[#e7cfcf] dark:border-white/10 overflow-hidden">
                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                        <label class="flex flex-col gap-2">
                            ...
                            <select wire:model.defer="formData.last_grade_level" 
                                    @if($enrollment_type === 'Incoming Grade 7') disabled @endif
                        ...
                        <label class="flex flex-col gap-2">
                            ...
                            <input wire:model.defer="formData.last_gwa" class="form-input rounded-lg border-[#e7cfcf] dark:border-white/20 bg-white/50 dark:bg-black/20 focus:border-primary focus:ring-primary h-12 text-sm" placeholder="e.g. 88.5" type="number" step="0.01"/>
